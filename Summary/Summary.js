  ...
  try {
    ...
    req.body.dataTableAnnual.map(({ customerName, region, plant, thisYear, productSubCat, matcode }, index) => {
      if (index == 0) {
        ...
        summaryData += `( '${req.body.textValue}-V-${req.body.numberValue}', '${customerName}' , '${thisYear.wtPerPC}' , '${thisYear.program}' , '${thisYear.productCat}' , '${plant}', '${matcode}' , '${thisYear.uniqueIdentificationNo}' , '${productSubCat}' , '${thisYear.teamLeader}' , '${region}' , ${thisYear.aprilSaleableUnit} , ${thisYear.aprilQuantity} , ${thisYear.aprilSqMt} , ${thisYear.aprilMt} ,${thisYear.aprilRate},${thisYear.aprilValue},${thisYear.aprilUSDN}, ${thisYear.aprilUVR} , ${thisYear.maySaleableUnit}, ${thisYear.maySqMt} , ${thisYear.mayMt} ,${thisYear.mayRate} , ${thisYear.mayQuantity} ,${thisYear.mayValue},${thisYear.mayUSDN}, ${thisYear.mayUVR} ,${thisYear.juneSaleableUnit}, ${thisYear.juneSqMt} , ${thisYear.juneMt} , ${thisYear.juneQuantity} , ${thisYear.juneRate} , ${thisYear.juneValue} , ${thisYear.juneUSDN}, ${thisYear.junUVR} , ${thisYear.julySaleableUnit}, ${thisYear.julyMt} , ${thisYear.julySqMt} , ${thisYear.julyQuantity},${thisYear.julyRate},${thisYear.julyValue},${thisYear.julyUSDN}, ${thisYear.julyUVR},${thisYear.augustSaleableUnit}, ${thisYear.augustSqMt} , ${thisYear.augMt} , ${thisYear.augustQuantity} ,${thisYear.augustRate},${thisYear.augustValue},${thisYear.augustUSDN}, ${thisYear.augUVR} ,${thisYear.septemberSaleableUnit}, ${thisYear.septemberSqMt} , ${thisYear.septemberMt} ,${thisYear.septemberQuantity} ,${thisYear.septemberRate},${thisYear.septemberValue},${thisYear.septemberUSDN},  ${thisYear.sepUVR} ,${thisYear.octoberSaleableUnit} , ${thisYear.octSqMt} , ${thisYear.octMt} , ${thisYear.octoberQuantity} ,${thisYear.octoberRate},${thisYear.octoberValue},${thisYear.octoberUSDN} , ${thisYear.octUVR},${thisYear.novemberSaleableUnit}, ${thisYear.novSqMt} , ${thisYear.novMt} , ${thisYear.novemberQuantity} ,${thisYear.novemberRate},${thisYear.novemberValue},${thisYear.novemberUSDN} , ${thisYear.novUVR},${thisYear.decemberSaleableUnit}, ${thisYear.decSqMt} , ${thisYear.decMt} ,${thisYear.decemberQuantity},${thisYear.decemberRate},${thisYear.decemberValue},${thisYear.decemberUSDN}, ${thisYear.decUVR},${thisYear.januarySaleableUnit}, ${thisYear.janSqMt} , ${thisYear.janMt} , ${thisYear.januaryQuantity} ,${thisYear.januaryRate},${thisYear.januaryValue},${thisYear.januaryUSDN}, ${thisYear.janUVR},${thisYear.februarySaleableUnit} , ${thisYear.febSqMt} , ${thisYear.febMt} , ${thisYear.februaryQuantity},${thisYear.februaryRate},${thisYear.februaryValue},${thisYear.februaryUSDN}, ${thisYear.febUVR},${thisYear.marchSaleableUnit}, ${thisYear.marchSqMt} , ${thisYear.marMt} , ${thisYear.marchQuantity} ,${thisYear.marchRate},${thisYear.marchValue}, ${thisYear.marchUSDN},${thisYear.marUVR},${thisYear.q1UVR},${thisYear.q2UVR},${thisYear.q3UVR},${thisYear.q4UVR}, ${thisYear.yearlyUVR} ),`
      }
